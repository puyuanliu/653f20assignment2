...
def plot():
    ...
    plt.title("Training Accuracy of Incremental Method",fontsize=20)
    ...
    plt.xlabel("Check Points",fontsize=20)
    plt.ylabel("Accuracies",fontsize=20)
    plt.title("Training Accuracy of batch Method",fontsize=20)
    ...
    plt.xlabel("Check Points",fontsize=20)
    plt.ylabel("Accuracies",fontsize=20)
    plt.title("Training Accuracy of My Method",fontsize=20)
    plt.savefig('my.png')
    ...
    plt.plot(checkpoints, ave_incremental_accuracy, linewidth=1.0,
                          label="Incremental Method Accuracy")
    ...
    plt.title("Comparison of Training Accuracy between different agent",fontsize=18)

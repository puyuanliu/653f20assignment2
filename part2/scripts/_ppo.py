...
def main():
  ...
  policy_optimizer = optim.Adam(my_policy.parameters(), lr=0.0003)
  baseline_optimizer = optim.Adam(my_baseline.parameters(), lr=0.0003)
    ...
    if going_to_update and done:
        ...
        for epoch in range(num_epochs):
            ...
            for m in range(num_mini_batch):
                ...
                for transition in range(m*mini_batch_size,(m+1)*mini_batch_size):
                # we first calculate the Goal (return) for every time steps
                ...
                mean_first_term = first_term/mini_batch_size
                mean_second_term = second_term/mini_batch_size
